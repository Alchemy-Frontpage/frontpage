...
document.addEventListener('DOMContentLoaded', function(event) {
    ...
    function stackedCards() {
        ...
        obj = document.getElementById('list-container');
        stackedCardsObj = obj.querySelector('.front-page-list');
        listElNodesObj = stackedCardsObj.children;

        // topObj = obj.querySelector('.stackedcards-overlay.top');
        rightObj = obj.querySelector('.keep-button');
        leftObj = obj.querySelector('.remove-button');
